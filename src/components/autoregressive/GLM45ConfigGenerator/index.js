...
/**
 * GLM-4.5 Configuration Generator
 * Supports GLM-4.5 model deployment configuration
 */
const GLM45ConfigGenerator = () => {
  const config = {
    modelFamily: 'zai-org',
    ...
    generateCommand: function (values) {
      ...
      const modelName = `${this.modelFamily}/GLM-4.5${modelSuffix}`;
...
export default GLM45ConfigGenerator;
