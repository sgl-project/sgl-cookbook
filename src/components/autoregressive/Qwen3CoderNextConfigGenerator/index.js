 ...
 * Supports Qwen3-Coder-Next 80B model with speculative decoding option
 */
  ...
  const config = {
    ...
    options: {
      ...
      toolcall: {
        ...
        commandRule: (value) => value === 'enabled' ? '--tool-call-parser qwen_coder' : null
      },
      speculative: {
        name: 'speculative',
    ...
    generateCommand: function (values) {
      ...
      const modelName = `Qwen/Qwen3-Coder-Next-${config.baseName}${thinkingSuffix}${quantSuffix}`;
