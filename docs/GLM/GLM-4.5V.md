...
```
Benchmark time: 96.50019593769684
answers saved to: ./answer_sglang.json
Evaluating...
answers saved to: ./answer_sglang.json
{'Accounting': {'acc': 0.2, 'num': 30},
 'Agriculture': {'acc': 0.167, 'num': 30},
 'Architecture_and_Engineering': {'acc': 0.2, 'num': 30},
 'Art': {'acc': 0.233, 'num': 30},
 'Art_Theory': {'acc': 0.367, 'num': 30},
 'Basic_Medical_Science': {'acc': 0.3, 'num': 30},
 'Biology': {'acc': 0.333, 'num': 30},
 'Chemistry': {'acc': 0.2, 'num': 30},
 'Clinical_Medicine': {'acc': 0.2, 'num': 30},
 'Computer_Science': {'acc': 0.167, 'num': 30},
 'Design': {'acc': 0.267, 'num': 30},
 'Diagnostics_and_Laboratory_Medicine': {'acc': 0.167, 'num': 30},
 'Economics': {'acc': 0.3, 'num': 30},
 'Electronics': {'acc': 0.133, 'num': 30},
 'Energy_and_Power': {'acc': 0.233, 'num': 30},
 'Finance': {'acc': 0.233, 'num': 30},
 'Geography': {'acc': 0.2, 'num': 30},
 'History': {'acc': 0.2, 'num': 30},
 'Literature': {'acc': 0.3, 'num': 30},
 'Manage': {'acc': 0.4, 'num': 30},
 'Marketing': {'acc': 0.233, 'num': 30},
 'Materials': {'acc': 0.267, 'num': 30},
 'Math': {'acc': 0.3, 'num': 30},
 'Mechanical_Engineering': {'acc': 0.167, 'num': 30},
 'Music': {'acc': 0.3, 'num': 30},
 'Overall': {'acc': 0.256, 'num': 900},
 'Overall-Art and Design': {'acc': 0.292, 'num': 120},
 'Overall-Business': {'acc': 0.273, 'num': 150},
 'Overall-Health and Medicine': {'acc': 0.307, 'num': 150},
 'Overall-Humanities and Social Science': {'acc': 0.233, 'num': 120},
 'Overall-Science': {'acc': 0.267, 'num': 150},
 'Overall-Tech and Engineering': {'acc': 0.19, 'num': 210},
 'Pharmacy': {'acc': 0.433, 'num': 30},
 'Physics': {'acc': 0.3, 'num': 30},
 'Psychology': {'acc': 0.3, 'num': 30},
 'Public_Health': {'acc': 0.433, 'num': 30},
 'Sociology': {'acc': 0.133, 'num': 30}}
