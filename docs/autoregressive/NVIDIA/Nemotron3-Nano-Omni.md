...
- [`nvidia/Nemotron-3-Nano-Omni-30B-A3B-Reasoning`](https://huggingface.co/nvidia/Nemotron-3-Nano-Omni-30B-A3B-Reasoning) — RL post-trained reasoning model (recommended)
...
import NemotronNanoOmniConfigGenerator from '@site/src/components/autoregressive/NemotronNanoOmniConfigGenerator';

<NemotronNanoOmniConfigGenerator />
